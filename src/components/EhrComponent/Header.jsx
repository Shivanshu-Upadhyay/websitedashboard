...
function Header(props) {
    ...
    return (
        <div style={{ height: '16vh', borderColor: 'black', backgroundColor: 'wheat' }}>
            ...
            <div style={{ marginLeft: '37vw', marginTop: '1vh', marginBottom: '0vh', fontSize: '1.3rem' }}>
                {props.selectedPatient.patientId}
            </div>

            <div className="line" style={{ marginLeft: '45.5vw', marginTop: '0vh' }}></div>


            <div style={{ marginLeft: '47vw', marginTop: '0vh', fontSize: '1.3rem' }}>
                +91-{props.selectedPatient.mobile}
            </div>

            <div>
                <Link to="/add-appointment"><EventNoteIcon style={{ marginLeft: '80vw', marginBottom: '6vh', marginTop: '-8vh', fontSize: "50px", color: 'black' }} fontSize="large" /></Link>
            </div>
