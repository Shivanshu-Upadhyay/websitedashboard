...
export default function AshuStepper() {
  ...
  const RadioComponent = ({ input }) => {
    ...
    return <Radio {...input} style={{color:"#2185d0"}}/>;
  };
          ...
          <Field name="weight">
            {({ input, meta }) => (
              <div className="field">
                ...
                <input type="text" {...input} onBlur={calculateWeight} id="weight" pattern="[0-9]+" required/>
                <PointingError input={input} meta={meta} />
              </div>
            )}
          </Field>
          ...
          <Field name="height">
            {({ input, meta }) => (
              <div className="field">
                ...
                <input type="text" {...input} onBlur={calculateHeight} id="height" pattern="[0-9]+" required/>
                <PointingError input={input} meta={meta} />
              </div>
            )}
          </Field>
