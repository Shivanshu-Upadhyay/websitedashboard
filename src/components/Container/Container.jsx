                ...
                <DialogActions>
                  ...
                  <Button
                    ...
                    onClick={() => {
                      setShowCalender(false);
                      selectDays.forEach((day) => {
                        var newDay = new Date(day).toISOString().substr(0, 10);
                        myArr.push(newDay);
                      })
                      filterData();
                    }}
                          ...
                          <Field name="ItemName">
                            {({ input, meta }) => (
                              <div>
                                ...
                                <input type="text" {...input} placeholder="" pattern="[a-zA-Z]+" required />
                              </div>
                            )}
                          </Field>
                        </div>
        ...
        <div className="expenseForm">
          ...
          >
            ...
            <DialogContent className={classes.contentss}>
              <Form onSubmit={handleIncomeSubmit}>
                {({ handleSubmit }) => (
                  <form onSubmit={handleSubmit} className="" style={{ width: '20rem' }}>
                    <Grid container alignItems="flex-start" spacing={1}>
                      <Grid item xs={12}>
                        <div>
                          <Field name="ItemName">
