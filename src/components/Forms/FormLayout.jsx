...
function FormLayout(props) {
  ...
  const handleSubmit = (formValues) => {
    ...
    data.treatment = findOne(treatments, { _id: formValues.treatment });
  ...
  const RadioComponent = ({ input, children }) => (
    <label>
      <Radio {...input} style={{color:"#2185d0"}}/>
      {children}
    </label>
  );
        ...
        <div className="ui form">
          <Field name="notes">
            {({ input, meta }) => (
              <div class="field">
                <label>Notes</label>
                <textarea rows="3" {...input} required></textarea>
                <PointingError input={input} meta={meta} />
              </div>
            )}
          </Field>
            ...
            <div className="inline fields">
              <Field name="generate.treatmentProtocol" type="checkbox">
                {({ input, meta }) => (
                  <div>
                    <FormControlLabel
                      control={<Checkbox name="checkedC" {...input} style={{color:"#2185d0"}}/>}
              ...
              <Field name="generate.dailyRegister" type="checkbox">
                {({ input, meta }) => (
                  <FormControlLabel
                    control={<Checkbox name="checkedD" {...input} style={{color:"#2185d0"}}/>}
              ...
              <Field name="generate.invoice" type="checkbox">
                {({ input, meta }) => (
                  <FormControlLabel
                    control={<Checkbox name="checkedE" {...input} style={{color:"#2185d0"}}/>}
                    label="Invoice"
                  />
                )}
              </Field>
