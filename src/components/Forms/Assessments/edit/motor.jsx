...
import { editMotorData } from "../../../../actions/motorExaminationAction";
...
function EditMotor(props) {
    ...
    const onSubmit = (formValues) => {
        ...
        console.log(data);
        props.editMotorData(data);
    };

    const initialValues = {
        date: props.motorData.date,
        cs: props.motorData.spine.cervical,
        ts: props.motorData.spine.thoracic,
        ls: props.motorData.spine.lumbar,
        csflex: props.motorData.date
    };
    console.log(props.motorData)
    return (
        <>
