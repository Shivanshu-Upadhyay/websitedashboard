  ...
  const onSubmit = (formValues) => {
    ...
    const data = {
      ...
      primitiveReflexes: {
        ...
        grasp: {
          present: formValues.p,
          integrated: formValues.q
        },
        footGrasp: {
          present: formValues.w,
          integrated: formValues.wxy
        },
        placing: {
          present: formValues.dd,
          integrated: formValues.ee
        },
        startle: {
          present: formValues.kk,
          integrated: formValues.ll
        },
        handOpening: {
          present: formValues.rr,
          integrated: formValues.ss
        }
      },
