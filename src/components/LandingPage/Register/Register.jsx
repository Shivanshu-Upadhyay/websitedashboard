...
const Register = (props) => {
  ...
  const required = value => (value ? undefined : 'Country Required')
      ...
      <Grid container spacing={1}>
        ...
        <Grid item>
          <div class="signup-image" style={{ marginLeft: '100px', marginTop: '88px' }}>
            ...
            <a onClick={() => { setOpenSignIn(true) }} class="signup-image-link" style={{ color: 'blueviolet' }}>I am already registered</a>
          </div>
        </Grid>
      </Grid>
      {openSignIn && (
